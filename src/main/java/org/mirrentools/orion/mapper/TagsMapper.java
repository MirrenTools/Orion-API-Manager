...
public interface TagsMapper {
	 ...
	 * @return
	 */
	List<Tags> selectAll(SqlAssist assist);
	 ...
	 * @return
	 */
	default LimitResult<Tags> limitAll(SqlAssist assist) {
		if (assist == null) {
		...
		LimitResult<Tags> result = new SqlAssist().new LimitResult<Tags>(count, assist.getPage(), assist.getRowSize());
		if (count == 0) {
			return result;
		}
		List<Tags> data = selectAll(assist);
		result.setData(data);
		return result;
	}
	 ...
	 * @return
	 */
	Tags selectSingleByObj(Tags data);
	 ...
	 * @return
	 */
	List<Tags> selectByObj(Tags data);
	 ...
	 * @return
	 */
	int insertBatch(List<Tags> data);
	 ...
	 * @return
	 */
	int updateAllByAssist(@Param("data") Tags data, @Param("assist") SqlAssist assist);
	 ...
	 * @return
	 */
	int updateNotNullByAssist(@Param("data") Tags data, @Param("assist") SqlAssist assist);
	/**
	 * 通过id获取数据
	 * 
	 * @param id
	 ...
	 * @return
	 */
	int updateNotNullById(Tags data);
}
