...
public interface UsersMapper {
	 ...
	 * @return
	 */
	List<Users> selectAll(SqlAssist assist);
	 ...
	 * @return
	 */
	default LimitResult<Users> limitAll(SqlAssist assist) {
		if (assist == null) {
		...
		LimitResult<Users> result = new SqlAssist().new LimitResult<Users>(count, assist.getPage(), assist.getRowSize());
		if (count == 0) {
			return result;
		}
		List<Users> data = selectAll(assist);
		result.setData(data);
		return result;
	}
	 ...
	 * @return
	 */
	Users selectSingleByObj(Users data);
	 ...
	 * @return
	 */
	List<Users> selectByObj(Users data);
	 ...
	 * @return
	 */
	int insertBatch(List<Users> data);
	 ...
	 * @return
	 */
	int updateAllByAssist(@Param("data") Users data, @Param("assist") SqlAssist assist);
	 ...
	 * @return
	 */
	int updateNotNullByAssist(@Param("data") Users data, @Param("assist") SqlAssist assist);
	/**
	 * 通过id获取数据
	 * 
	 * @param id
	 ...
	 * @return
	 */
	int updateNotNullById(Users data);
}
